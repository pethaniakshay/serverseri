...
<body class="error-body no-top">
  <div class="container">
    <div class="row login-container column-seperation">
      <div class="col-md-5 col-md-offset-1">
        ...
        <p>
          Type in your email <br> And we'll send you the steps to reset it!
        </p>
      </div>
      <div class="col-md-5">
        <br>
        ...
        <jsp:include page="/WEB-INF/views/csrf.jsp" />
          ...
          <div class="row">
            <div class="col-md-10">
              ...
              <button id="submit" class="btn btn-primary btn-cons pull-right" type="button">Send me the steps!</button>
            </div>
          </div>
        </form>
      </div>
  ...
  <script src="${contextPath}/resources/business_js/forgot_password.js" type="text/javascript"></script>
