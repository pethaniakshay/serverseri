...
public class ServerValidator {
  ...
  public Map<String,Object> validateNewServer(Map<String,Object> serverData){
   ...
   //Check weather the server is blocked or suspended previously by violating the policies.
   //Check weather user have reached the maximum number of registration limit 
   
   
   //Also perform password lenght validation  and username lenght validation. Server name length
   ...
   //Also implement password strength utility and also check the Linux minimum password strength requirement.
